 ...
 *
 */
public class TypeResolver extends FatjsBaseListener {
    ...
    //设置所声明的变量的类型
    @Override
    public void exitVariableDeclarators(FatjsParser.VariableDeclaratorsContext ctx) {
    ...
    //把类成员变量的声明加入符号表
    @Override
    public void enterVariableDeclaratorId(FatjsParser.VariableDeclaratorIdContext ctx) {
    ...
    @Override
    public void exitFormalParameter(FatjsParser.FormalParameterContext ctx) {
        // 设置参数类型
    ...
    @Override
    public void exitTypeTypeOrVoid(FatjsParser.TypeTypeOrVoidContext ctx) {
        if (ctx.VOID() != null) {
    ...
    @Override
    public void exitTypeType(FatjsParser.TypeTypeContext ctx) {
        // 冒泡，将下级的属性标注在本级
    ...
    @Override
    public void enterClassOrInterfaceType(FatjsParser.ClassOrInterfaceTypeContext ctx) {
    ...
    @Override
    public void exitFunctionType(FatjsParser.FunctionTypeContext ctx) {
        ...
        if (ctx.typeList() != null) {
            FatjsParser.TypeListContext tcl = (FatjsParser.TypeListContext) ctx.typeList();
            for (FatjsParser.TypeTypeContext ttc : tcl.typeType()) {
    ...
    @Override
    public void exitPrimitiveType(FatjsParser.PrimitiveTypeContext ctx) {
        Type type = null;
        if (ctx.BOOLEAN() != null) {
