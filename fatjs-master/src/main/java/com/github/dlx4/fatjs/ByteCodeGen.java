 ...
 *
 * 5.运行示例程序： java play.Fatjs -bc bytecode.play
 */
public class ByteCodeGen extends FatjsBaseVisitor<Object> implements Opcodes {
    ...
    public Object visitExpression(ExpressionContext ctx) {
        ...
        //赋值
        if (ctx.bop != null && ctx.bop.getType() == FatjsParser.ASSIGN){
            //左侧必须是一个左值，现在只考虑变量名
