...
public class TypeChecker extends FatjsBaseListener {
...
//    }
     ...
     * @param operand
     */
    private void checkNumericOperand(Type type, FatjsParser.ExpressionContext exp, FatjsParser.ExpressionContext operand) {
     ...
     * @param operand
     */
    private void checkBooleanOperand(Type type, FatjsParser.ExpressionContext exp, FatjsParser.ExpressionContext operand) {
